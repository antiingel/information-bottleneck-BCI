...
O1_index = 15
O2_index = 28
output_folder_path = os.path.join(os.pardir, os.pardir, "dataset1", "eeg_data")
...
for subject in subjects:
    for recording in recordings:
        ...
        for frequency in frequencies:
            input_file_path = os.path.join(os.pardir, os.pardir, "dataset1", "original_data_as_csv", frequency + "sub" + subject + "trial" + recording + ".csv")
