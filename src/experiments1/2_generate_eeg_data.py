...
O2_index = 28
Cz_index = 1
output_folder_path = os.path.join(os.pardir, os.pardir, "data", "eeg_data")
...
for subject in subjects:
    for recording in recordings:
        ...
        for frequency in frequencies:
            input_file_path = os.path.join(os.pardir, os.pardir, "data", "original_data_as_csv", frequency + "sub" + subject + "trial" + recording + ".csv")
