...
def get_breakpoints(breakpoints_count):
    ...
    for i in range(breakpoints_count):
        breakpoints_list.append(int(window_length / breakpoints_count * i))
...
for subject in subjects:
    for recording in recordings:
        input_file_path = os.path.join(os.pardir, os.pardir, "data", "eeg_data", "sub" + subject + "rec" + recording + ".csv")
        output_file_path = os.path.join(os.pardir, os.pardir, "data", "feature_data", "sub" + subject + "rec" + recording + ".csv")
        all_data = pd.read_csv(input_file_path)
        eeg_data = all_data[["A1 (Cz)", "A15 (O1)", "A28 (O2)"]].to_numpy()
        label_data = all_data["label"].to_numpy()
        eeg_data = np.array((eeg_data[:,1]-eeg_data[:,0], eeg_data[:,2]-eeg_data[:,0])).T
        ...
        reference_signals = getReferenceSignals(window_length, frequencies, [[1,2,3],[1,2,3],[1,2,3]])
        ...
        for window, labels in zip(split_data, split_labels):
            ...
            for channel in window:
                ...
                psd_featuress = [amplitude_spectrum[frequency-1] for frequency in frequencies]
            ...
            psd_features = [amplitude_spectrum[frequency*harmonic - 1] for harmonic in [1,2,3] for frequency in frequencies]
            sum_psd_features = [sum(amplitude_spectrum[frequency*harmonic - 1] for harmonic in [1,2,3]) for frequency in frequencies]
            all_features.append(psd_features + sum_psd_features + cca_features + [frequencies.index(labels[-1]) + 1])

        feature_names = [
            "1_('O1', 'O2')_Sum PSDA_('O1', 'O2')_1_8.0",
            "1_('O1', 'O2')_Sum PSDA_('O1', 'O2')_1_14.0",
            "1_('O1', 'O2')_Sum PSDA_('O1', 'O2')_1_28.0",
            "1_('O1', 'O2')_Sum PSDA_('O1', 'O2')_2_8.0",
            "1_('O1', 'O2')_Sum PSDA_('O1', 'O2')_2_14.0",
            "1_('O1', 'O2')_Sum PSDA_('O1', 'O2')_2_28.0",
            "1_('O1', 'O2')_Sum PSDA_('O1', 'O2')_3_8.0",
            "1_('O1', 'O2')_Sum PSDA_('O1', 'O2')_3_14.0",
            "1_('O1', 'O2')_Sum PSDA_('O1', 'O2')_3_28.0",
            "1_('O1', 'O2')_Sum PSDA_('O1', 'O2')_Sum_8.0",
            "1_('O1', 'O2')_Sum PSDA_('O1', 'O2')_Sum_14.0",
            "1_('O1', 'O2')_Sum PSDA_('O1', 'O2')_Sum_28.0",
            "2_('O1', 'O2')_CCA_('O1', 'O2')_Sum_8.0",
            "2_('O1', 'O2')_CCA_('O1', 'O2')_Sum_14.0",
            "2_('O1', 'O2')_CCA_('O1', 'O2')_Sum_28.0",
        ]
